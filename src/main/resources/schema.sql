...
INSERT INTO admin (user_name, hashed_password, created_at, updated_at)
VALUES ('admin',
...
alter table attendances add foreign key (teacher_id) references teachers(id);
...
alter table student_attendance add foreign key (student_id) references students(id);
